...
int main(void) {
  ...
  11:	68 78 08 00 00       	push   $0x878
  16:	6a 01                	push   $0x1
  18:	e8 33 05 00 00       	call   550 <printf>
	printf(1, "count: %d\n",getcount());
  1d:	e8 61 04 00 00       	call   483 <getcount>
  ...
  47:	68 9e 08 00 00       	push   $0x89e
  4c:	e8 d2 03 00 00       	call   423 <open>
        printf(1, "count: %d\n", getcount());
  51:	e8 2d 04 00 00       	call   483 <getcount>
  56:	83 c4 0c             	add    $0xc,%esp
  59:	50                   	push   %eax
  5a:	68 86 08 00 00       	push   $0x886
  5f:	6a 01                	push   $0x1
  61:	e8 ea 04 00 00       	call   550 <printf>

	printf(1, "trace call output: %d\n", trace("../dummy"));
  66:	c7 04 24 a9 08 00 00 	movl   $0x8a9,(%esp)
  6d:	e8 19 04 00 00       	call   48b <trace>
  72:	83 c4 0c             	add    $0xc,%esp
  75:	50                   	push   %eax
  76:	68 b2 08 00 00       	push   $0x8b2
  7b:	6a 01                	push   $0x1
  7d:	e8 ce 04 00 00       	call   550 <printf>
	printf(1, "count: %d\n", getcount());
  82:	e8 fc 03 00 00       	call   483 <getcount>
  87:	83 c4 0c             	add    $0xc,%esp
  8a:	50                   	push   %eax
  8b:	68 86 08 00 00       	push   $0x886
  90:	6a 01                	push   $0x1
  92:	e8 b9 04 00 00       	call   550 <printf>

	trace("test_1.txt");
  97:	c7 04 24 9e 08 00 00 	movl   $0x89e,(%esp)
  9e:	e8 e8 03 00 00       	call   48b <trace>
	printf(1, "open text 1\n");
  a3:	58                   	pop    %eax
  a4:	5a                   	pop    %edx
  a5:	68 91 08 00 00       	push   $0x891
  aa:	6a 01                	push   $0x1
  ac:	e8 9f 04 00 00       	call   550 <printf>
	open("test_1.txt",  O_RDONLY | O_CREATE);
  b1:	59                   	pop    %ecx
  b2:	58                   	pop    %eax
  b3:	68 00 02 00 00       	push   $0x200
  b8:	68 9e 08 00 00       	push   $0x89e
  bd:	e8 61 03 00 00       	call   423 <open>
	printf(1, "count: %d\n", getcount());
  c2:	e8 bc 03 00 00       	call   483 <getcount>
  c7:	83 c4 0c             	add    $0xc,%esp
  ca:	50                   	push   %eax
  cb:	68 86 08 00 00       	push   $0x886
  d0:	6a 01                	push   $0x1
  d2:	e8 79 04 00 00       	call   550 <printf>
	printf(1, "open text 1\n");
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	68 91 08 00 00       	push   $0x891
  de:	6a 01                	push   $0x1
  ...
  ec:	68 9e 08 00 00       	push   $0x89e
  f1:	e8 2d 03 00 00       	call   423 <open>
        printf(1, "count: %d\n", getcount());
  f6:	e8 88 03 00 00       	call   483 <getcount>
  fb:	83 c4 0c             	add    $0xc,%esp
  fe:	50                   	push   %eax
  ff:	68 86 08 00 00       	push   $0x886
 104:	6a 01                	push   $0x1
 ...
 120:	68 d6 08 00 00       	push   $0x8d6
 125:	e8 f9 02 00 00       	call   423 <open>
        printf(1, "count: %d\n", getcount());
 12a:	e8 54 03 00 00       	call   483 <getcount>
 12f:	83 c4 0c             	add    $0xc,%esp
 132:	50                   	push   %eax
 133:	68 86 08 00 00       	push   $0x886
 138:	6a 01                	push   $0x1
 13a:	e8 11 04 00 00       	call   550 <printf>

	trace("test_2.txt");
 13f:	c7 04 24 d6 08 00 00 	movl   $0x8d6,(%esp)
 146:	e8 40 03 00 00       	call   48b <trace>
	printf(1, "open text 2\n");
 14b:	58                   	pop    %eax
 14c:	5a                   	pop    %edx
 14d:	68 c9 08 00 00       	push   $0x8c9
 152:	6a 01                	push   $0x1
 ...
 160:	68 d6 08 00 00       	push   $0x8d6
 165:	e8 b9 02 00 00       	call   423 <open>
        printf(1, "count: %d\n", getcount());
 16a:	e8 14 03 00 00       	call   483 <getcount>
 16f:	83 c4 0c             	add    $0xc,%esp
 172:	50                   	push   %eax
 173:	68 86 08 00 00       	push   $0x886
 178:	6a 01                	push   $0x1
 17a:	e8 d1 03 00 00       	call   550 <printf>

	exit();
 17f:	e8 5f 02 00 00       	call   3e3 <exit>
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba e1 08 00 00       	mov    $0x8e1,%edx
        while(*s != 0){
 ...
 6f1:	a1 e8 0b 00 00       	mov    0xbe8,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 e8 0b 00 00    	mov    0xbe8,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
