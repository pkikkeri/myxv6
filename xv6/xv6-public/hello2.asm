...
int main(void) {
  ...
  24:	68 75 07 00 00       	push   $0x775
  29:	e8 e5 02 00 00       	call   313 <open>
        printf(1, "count: %d\n", getcount());
  2e:	e8 40 03 00 00       	call   373 <getcount>
  33:	83 c4 0c             	add    $0xc,%esp
  36:	50                   	push   %eax
  37:	68 80 07 00 00       	push   $0x780
  3c:	6a 01                	push   $0x1
  3e:	e8 fd 03 00 00       	call   440 <printf>
	
	trace("test_2.txt");
  43:	c7 04 24 75 07 00 00 	movl   $0x775,(%esp)
  4a:	e8 2c 03 00 00       	call   37b <trace>
	open("test_2.txt",  O_RDONLY | O_CREATE);
  4f:	59                   	pop    %ecx
  50:	58                   	pop    %eax
  51:	68 00 02 00 00       	push   $0x200
  56:	68 75 07 00 00       	push   $0x775
  5b:	e8 b3 02 00 00       	call   313 <open>
	printf(1, "count: %d\n", getcount());
  60:	e8 0e 03 00 00       	call   373 <getcount>
  65:	83 c4 0c             	add    $0xc,%esp
  68:	50                   	push   %eax
  69:	68 80 07 00 00       	push   $0x780
  6e:	6a 01                	push   $0x1
