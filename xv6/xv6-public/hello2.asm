...
int main(void) {
  ...
  1d:	58                   	pop    %eax
  1e:	5a                   	pop    %edx
  1f:	68 00 02 00 00       	push   $0x200
  24:	68 85 07 00 00       	push   $0x785
  29:	e8 f5 02 00 00       	call   323 <open>
        printf(1, "count: %d\n", getcount());
  2e:	e8 50 03 00 00       	call   383 <getcount>
  33:	83 c4 0c             	add    $0xc,%esp
  36:	50                   	push   %eax
  37:	68 90 07 00 00       	push   $0x790
  3c:	6a 01                	push   $0x1
  3e:	e8 0d 04 00 00       	call   450 <printf>
	
	trace("test_2.txt");
  43:	c7 04 24 85 07 00 00 	movl   $0x785,(%esp)
  4a:	e8 3c 03 00 00       	call   38b <trace>
	printf(1, "open text 2\n");
  4f:	59                   	pop    %ecx
  50:	58                   	pop    %eax
  ...
  64:	68 85 07 00 00       	push   $0x785
  69:	e8 b5 02 00 00       	call   323 <open>
	printf(1, "count: %d\n", getcount());
  6e:	e8 10 03 00 00       	call   383 <getcount>
  73:	83 c4 0c             	add    $0xc,%esp
  76:	50                   	push   %eax
  77:	68 90 07 00 00       	push   $0x790
  7c:	6a 01                	push   $0x1
